    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Page $data) {
                                ...
                                $status = '<div class="action-list d-inline"><select class="process select droplinks '.$class.'"><option data-val="1" value="'. route('admin-page-status',['id1' => $data->id, 'id2' => 1]).'" '.$s.'>'.__('On').'</option><option data-val="0" value="'. route('admin-page-status',['id1' => $data->id, 'id2' => 0]).'" '.$ns.'>'.__('Off').'</option>/select></div>';
                                
                                return '<div class="action-list"><a data-href="' . route('admin-page-edit',$data->id) . '" class="edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit"></i>Edit</a><a href="javascript:;" data-href="' . route('admin-page-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a>'.$status.'</div>';
                            }) 
