                               ...
                               {{__('Loader')}} :
                                      ...
                                      <div class="action-list">
                                          <select class="process select droplinks {{ $gs->is_admin_loader == 1 ? 'drop-success' : 'drop-danger' }}">
                                            <option data-val="1" value="{{ route('admin-gs-is-admin-loader',1) }}" {{ $gs->is_admin_loader == 1 ? 'selected' : '' }}>Activated</option>
                                            <option data-val="0" value="{{ route('admin-gs-is-admin-loader',0) }}" {{ $gs->is_admin_loader == 0 ? 'selected' : '' }}>Deactivated</option>
                                          </select>
                                        </div>
                          </div>
