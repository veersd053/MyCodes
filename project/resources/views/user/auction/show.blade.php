    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="links">
            ...
            <li>
                <a href="{{ route('user-auction-show',$data->id) }}">{{ __('Auction Details') }}</a>
            </li>
        </ul>
      </div>
    </div>
                                            ...
                                            <tr>
                                               ...
                                               @if($data->bid_id != 0)
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($bid->status != 1) 
                                                            <a href="{{ route('user-auction-remove-winner',$bid->id) }}"><i class="fas fa-times-circle"></i> {{__('Remove Winner')}} </a></div>
                                                        @endif
                                                    </td>
                                                    @else
                                                    <td>
                                                ...
                                                @else
                                                <td><div class="action-list"><a href="{{ route('user-auction-winner',$bid->id) }}"><i class="fas fa-trophy"></i> {{__('Make Winner')}}</a></div></td>
                                                @endif
                                            </tr>
                                            @endforeach
                                            </tbody>
