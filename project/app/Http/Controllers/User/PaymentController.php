...
class PaymentController extends Controller
{
 ...
 public function store(Request $request){
     ...
     $return_url = action('User\PaymentController@payreturn');
     $cancel_url = action('User\PaymentController@paycancle');
     $notify_url = action('User\PaymentController@notify');
    ...
    // Redirect to paypal IP
     ...
     public function payreturn(){
         return redirect()->route('user-bid-index')->with('success','Payment Completed.');
     }
