...
class AuctionPaypalController extends Controller
{


     public function payment($id){
        $data = Auction::findOrFail($id);
        return view('user.auction.payment',compact('data'));
     }
 ...
 public function store(Request $request){
     ...
     $return_url = action('User\AuctionPaypalController@payreturn');
     $cancel_url = action('User\AuctionPaypalController@paycancle');
     $notify_url = action('User\AuctionPaypalController@notify');
    ...
    // Redirect to paypal IP
     ...
     public function payreturn(){
         return redirect()->route('user-auction-index')->with('success','Payment Completed.');
     }
...
// Set TCP timeout to 30 seconds
    ...
    if (strcmp($res, "VERIFIED") == 0 || strcasecmp($res, "VERIFIED") == 0) {
        ...
        $payment = Order::where('order_number',$_POST['item_number'])
