                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                          <textarea class="input-field" name="c_title" placeholder="{{__('Title')}}" required="" rows="5">{{$data->c_title}} </textarea>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                          <textarea class="input-field" name="c_text" placeholder="{{__('Text')}}" required="" rows="5">{{$data->c_text}} </textarea>
