...
@section('content')
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{__('Edit Auction')}}<a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i>Back</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('user-auction-edit',$data->id) }}">{{__('Edit Auction')}}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('user-auction-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <select class="input-field" name="conditions" required="">
                                    ...
                                    <option value="Used" {{ $data->conditions == "Used" ? 'selected' : '' }}>Used</option>
                                    <option value="Recondition" {{ $data->conditions == "Recondition" ? 'selected' : '' }}>Recondition</option>
                                </select>
                            </div>
                          </div>
