                                        ...
                                        <div class="col-sm-4">
                                            <label class="control-label" for="subtitle_anime">{{__('Animation')}} *</label>
                                              <select class="form-control" id="subtitle_anime" name="subtitle_anime">
                                                    <option value="fadeIn">{{__('fadeIn')}}</option>
                                                    <option value="fadeInDown">{{__('fadeInDown')}}</option>
                                                    <option value="fadeInLeft">{{__('fadeInLeft')}}</option>
                                                    <option value="fadeInRight">{{__('fadeInRight')}}</option>
                                                    <option value="fadeInUp">{{__('fadeInUp')}}</option>
                                                    <option value="flip">{{__('flip')}}</option>
                                                    <option value="flipInX">{{__('flipInX')}}</option>
                                                    <option value="flipInY">{{__('flipInY')}}</option>
                                                    <option value="slideInUp">{{__('slideInUp')}}</option>
                                                    <option value="slideInDown">{{__('slideInDown')}}</option>
                                                    <option value="slideInLeft">{{__('slideInLeft')}}</option>
                                                    <option value="slideInRight">{{__('slideInRight')}}</option>
                                                    <option value="rollIn">{{__('rollIn')}}</option>
                                              </select>
                                        </div>
                                        </div>
