...
class BidController extends Controller
{
    ...
    {   
        ...
        if($auction->status == 0)
        {
            if($isApi) 
            {
                return response()->json(['error'=>"This auction is closed!"]);
            }
        ...
        if($bid_amount < $auction->start_bid)
        {
            if($isApi) 
            {
                return response()->json(['error'=>'Minimum Bid Amount is: '.$gs->currency_sign.$auction->start_bid]);
            }
        ...
        if(isset($highest))
        {
            ...
            {   
                ...
                if(isset($ck)){
                    ...
                    if($gs->bid_increase > 0){
                        ...
                        if($bid_amount < $h_amnt->highest_amount){
                            ...
                            if($isApi) 
                            {
                                return response()->json(['error'=>'Your Bid was Higher from Current bid!']);
                            }
                            ...
                            if($isApi) 
                            {
                                return response()->json(['error'=>'This Amount Has Already been Taken.']);
                            }
                ...
                if($isApi) 
                {
                    return response()->json(['success'=>'Your Bid Placed Successfully.']);
                }
                ...
                if($isApi) 
                {
                    return response()->json(['error'=>'Your Bid Amount is Lower than highest Bid.']);
                }
