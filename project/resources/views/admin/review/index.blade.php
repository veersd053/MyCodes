                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="review_title" value="{{ App\Models\Pagesetting::findOrFail(1)->review_title }}" placeholder="{{__('Enter Title')}}" required>
                            </div>
                          </div>
                    </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="review_text" value="" placeholder="{{__('Enter Text')}}" required>{{ App\Models\Pagesetting::findOrFail(1)->review_text }}</textarea>
                            </div>
                          </div>
                    </div>
