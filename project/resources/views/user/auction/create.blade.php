...
@section('content')
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{__('Add New Auction')}}<a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> Back</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('user-auction-create') }}">{{__('Add New Auction')}}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                        ...
                        <form id="auctionform" action="{{route('user-auction-store')}}" method="POST" enctype="multipart/form-data">
					                   {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="checkbox-wrapper">
                              ...
                              <label for="is_featured">{{ __('Add This Auction To Featured') }} ({{ __('Price') }} {{ $gs->currency_format == 0 ? $gs->currency_sign.number_format($gs->feature_price, 2, ',', '.') : number_format($gs->feature_price, 2, ',', '.').$gs->currency_sign }})</label>
...
// Gallery Section Insert
  ...
  $(document).on('click', '#prod_gallery' ,function() {
    ...
    $('#auctionform').find('.removegal').val(0);
  });
  ...
  $("#uploadgallery").change(function(){
     ...
     for(var i=0;i<total_file;i++)
     {
      $('.selected-image .row').append('<div class="col-sm-6">'+
                                        ...
                                        '</div>'+
                                  '</div> ');
      $('#auctionform').append('<input type="hidden" name="galval[]" id="galval'+i+'" class="removegal" value="'+i+'">')
     }
