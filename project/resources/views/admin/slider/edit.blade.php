                      ...
                      @include('includes.admin.form-both') 
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  <div class="col-sm-12">
                                                   <div class="row">
                                                      <div class="col-sm-4">
                                                      <label class="control-label" for="subtitle_size">{{__('Font Size')}} *<span> (px)</span></label>
                                              ...
                                              <div class="col-sm-4">
                                                  <label class="control-label" for="subtitle_anime">{{__('Animation')}} *</label>
                                                    <select class="form-control" id="subtitle_anime" name="subtitle_anime">
                                                          <option value="fadeIn" {{$data->subtitle_anime == 'fadeIn' ? 'selected' :''}}>{{__('fadeIn')}}</option>
                                                          <option value="fadeInDown" {{$data->subtitle_anime == 'fadeInDown' ? 'selected' :''}}>{{__('fadeInDown')}}</option>
                                                          <option value="fadeInLeft" {{$data->subtitle_anime == 'fadeInLeft' ? 'selected' :''}}>{{__('fadeInLeft')}}</option>
                                                          <option value="fadeInRight" {{$data->subtitle_anime == 'fadeInRight' ? 'selected' :''}}>{{__('fadeInRight')}}</option>
                                                          <option value="fadeInUp" {{$data->subtitle_anime == 'fadeInUp' ? 'selected' :''}}>{{__('fadeInUp')}}</option>
                                                          <option value="flip" {{$data->subtitle_anime == 'flip' ? 'selected' :''}}>{{__('flip')}}</option>
                                                          <option value="flipInX" {{$data->subtitle_anime == 'flipInX' ? 'selected' :''}}>{{__('flipInX')}}</option>
                                                          <option value="flipInY" {{$data->subtitle_anime == 'flipInY' ? 'selected' :''}}>{{__('flipInY')}}</option>
                                                          <option value="slideInUp" {{$data->subtitle_anime == 'slideInUp' ? 'selected' :''}}>{{__('slideInUp')}}</option>
                                                          <option value="slideInDown" {{$data->subtitle_anime == 'slideInDown' ? 'selected' :''}}>{{__('slideInDown')}}</option>
                                                          <option value="slideInLeft" {{$data->subtitle_anime == 'slideInLeft' ? 'selected' :''}}>{{__('slideInLeft')}}</option>
                                                          <option value="slideInRight" {{$data->subtitle_anime == 'slideInRight' ? 'selected' :''}}>{{__('slideInRight')}}</option>
                                                          <option value="rollIn" {{$data->subtitle_anime == 'rollIn' ? 'selected' :''}}>{{__('rollIn')}}</option>
                                                    </select>
                                              </div>
                                              </div>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  <div class="col-sm-12">
                                                   <div class="row">
                                                      <div class="col-sm-4">
                                                      <label class="control-label" for="title_size">{{__('Font Size')}} *<span> (px)</span></label>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="details_text" id="details_text" rows="5"  placeholder="{{__('Enter Title Text')}}">{{$data->details_text}}</textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  <div class="col-sm-12">
                                                   <div class="row">
                                                      <div class="col-sm-4">
                                                      <label class="control-label" for="details_size">{{__('Font Size')}} *<span> (px)</span></label>
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/images/sliders/'.$data->photo):asset('assets/images/noimage.png') }});">
                                  ...
                                  <p class="text">{{__('Prefered Size')}}: {{__('(1920x800) or Square Sized Image')}}</p>
                            </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link" placeholder="{{__('Link')}}" required="" value="{{$data->link}}">
