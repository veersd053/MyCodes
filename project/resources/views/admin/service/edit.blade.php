                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-service-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="nic-edit" name="details" rows="5" placeholder="{{__('Details')}}">{{ $data->details }}</textarea> 
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link" placeholder="https://www.google.com/" required="" value="{{$data->link}}">
                          </div>
                        </div>
